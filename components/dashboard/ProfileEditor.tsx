...
import { Save, User, Mail, MapPin, Globe, Github, Linkedin, Twitter } from 'lucide-react';
...
export function ProfileEditor({ isDark }: ProfileEditorProps) {
  ...
  const textAreas = [
    { key: 'bio', label: 'Biographie', placeholder: 'Décrivez-vous en quelques phrases...' },
    { key: 'skills', label: 'Compétences', placeholder: 'Listez vos compétences techniques...' },
    { key: 'experience', label: 'Expérience', placeholder: 'Décrivez votre expérience professionnelle...' },
    { key: 'education', label: 'Formation', placeholder: 'Votre parcours éducatif...' }
  ];
    ...
    <div className="space-y-8">
      ...
      {savedProfile && (
        <div className={`p-4 rounded-xl ${
          isDark ? 'bg-green-900/20 border border-green-800' : 'bg-green-100 border border-green-300'
        }`}>
